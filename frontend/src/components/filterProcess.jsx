...
const FilterProcess = () => {
    ...
    return (
        <div className="border border-stroke lg:rounded-2xl md:rounded-xl rounded-lg  lg:text-xl md:text-lg text-xs h-fit lg:p-5 md:p-3 sm:p-2 p-2 text-textfilter ">
       <div>
