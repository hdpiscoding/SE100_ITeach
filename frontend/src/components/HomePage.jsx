  ...
  return (
    <div className='mx-4 md:mx-8 lg:mx-20'>
      ...
      <div className='my-8 md:my-14 flex overflow-x-auto flex-wrap justify-center space-x-3 md:space-x-5 pb-4 md:pb-0'>
        <Button className='bg-white text-black hover:bg-SignUp active:bg-SignUp border-2 whitespace-nowrap min-w-[150px]'>All Program</Button>
        <Button className='bg-white text-black hover:bg-SignUp active:bg-SignUp border-2 whitespace-nowrap min-w-[150px]'>All Program</Button>
        <Button className='bg-white text-black hover:bg-SignUp active:bg-SignUp border-2 whitespace-nowrap min-w-[150px]'>All Program</Button>
        <Button className='bg-white text-black hover:bg-SignUp active:bg-SignUp border-2 whitespace-nowrap min-w-[150px]'>All Program</Button>
        <Button className='bg-white text-black hover:bg-SignUp active:bg-SignUp border-2 whitespace-nowrap min-w-[150px]'>All Program</Button>
        ...
        <div className='w-full md:w-[500px] p-8 md:p-14 relative z-10'>
          ...
          <div className='mt-7 space-y-4'>
            <div className='flex items-start gap-2'>
              <Image className='mt-1' src="/assets/images/star.png" width={25} height={25} alt="star"/>
