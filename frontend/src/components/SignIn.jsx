...
const SignIn = () => {
  return (
    ...
    <Image className='inline-block' src="/assets/images/bg_login.png" width={400} height={100} />
    <div className=' w-[400px]'>
       ...
       <div className='space-y-2 mt-5'>
        ...
        <div className='border-2  p-1 flex justify-between bg-gray'> 
            ...
            <Image className='inline-block' src="/assets/images/arrow_down.png" width={25} height={20} />
        </div>
         </div>
